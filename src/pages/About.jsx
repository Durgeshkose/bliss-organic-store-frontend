  ...
  const journeySteps = [
    {
      ...
      description: "Founded with a vision to make organic living accessible to everyone"
    },
    {
      year: "2019",
      title: "First Harvest",
    ...
    },
    {
      ...
      description: "Reached 10,000+ happy customers and launched sustainability initiatives"
    },
    {
      year: "2024",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
            We believe in the power of nature to nourish, heal, and sustain. Our journey began with a simple 
            mission: to bring you the purest, most sustainable products that honor both your health and our planet.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-green-800 mb-4">Our Mission & Vision</h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Guided by our core values, we're committed to creating a healthier, more sustainable world
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-xl font-semibold text-green-800 mb-4">Nature First</h3>
              <p className="text-gray-600">
                We source only the finest natural ingredients, respecting the earth's bounty while delivering 
                exceptional quality to your doorstep.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-gray-600">
                Building a community of like-minded individuals who share our passion for sustainable living 
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-xl font-semibold text-green-800 mb-4">Trust</h3>
              <p className="text-gray-600">
                Transparency in our processes, authenticity in our products, and integrity in every interaction 
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-green-50 to-emerald-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              The passionate individuals behind Bliss Organic Store, dedicated to bringing you the best of nature
            </p>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-green-800 mb-4">Our Journey</h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                  ...
                  <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <div className="flex items-center mb-4">
                      <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center">
                        <span className="text-green-600 font-bold">{step.year}</span>
                      </div>
                    </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-green-50 to-emerald-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-green-800 mb-4">Our Commitment to Sustainability</h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Every choice we make is guided by our responsibility to protect and preserve our planet
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 text-center">
              ...
              <h3 className="text-lg font-semibold text-green-800 mb-2">Zero Waste</h3>
              <p className="text-gray-600 text-sm">Minimal packaging, maximum impact</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 text-center">
              ...
              <p className="text-gray-600 text-sm">Protecting our most precious resource</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 text-center">
              ...
              <h3 className="text-lg font-semibold text-green-800 mb-2">Renewable Energy</h3>
              <p className="text-gray-600 text-sm">Powered by clean, sustainable energy</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 text-center">
              ...
              <h3 className="text-lg font-semibold text-green-800 mb-2">Certified Organic</h3>
              <p className="text-gray-600 text-sm">Verified quality and authenticity</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-green-600 to-emerald-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-green-100 text-lg mb-8 max-w-2xl mx-auto">
            Be part of our growing community and stay updated with the latest in sustainable living, 
            exclusive offers, and nature-inspired wellness tips.
          </p>
